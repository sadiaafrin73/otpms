...
<div class="tab-content" id="myTabContent">
  ...
  <div class="">
            ...
            <p>
            <label for="">Tutor Name:</label>{{auth()->user()->name}}
            </p>
            
            <p>
            <label for="">Tutor Email:</label>{{auth()->user()->email}}
            </p>
            <p>
            ...
            <p>
            <label for="">Educational Qualification:</label>{{$tutor->educational_qualification}}
            </p>
            <p>
